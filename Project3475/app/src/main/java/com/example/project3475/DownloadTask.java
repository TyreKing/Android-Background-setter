...
public class DownloadTask extends AsyncTask<String,Void, String> {
    ...
    private boolean isThereAnErrorCode;
        ...
        try {
            ...
            try {
                ...
                if (statusCode / 100 != 2) {
                    ...
                    isThereAnErrorCode = true;
                    return null;
                }
                isThereAnErrorCode = false;
    ...
    protected void onPostExecute(String result) {
        ...
        if (myActivity != null) {
            if(!isThereAnErrorCode) {
                myActivity.setContentView(R.layout.activity_main);
                myActivity.setup();
                myActivity.processJSON(result);
                myActivity.spinnerSetup();
            }
            else {
                myActivity.setContentView(R.layout.error_code);
            }
        }
    }
